...
Por practicidad y temas de orden, el código del simulador puede ser encontrado en el notebook titulado 'planet_visualizer.ipynb' ubicado dentro de esta misma carpeta <a href="https://github.com/raylovesmusic/IMT2200-Proyecto-Grupal-A.R.D.E/tree/main/notebooks">'notebooks'</a>, destinado a cumplir con este objetivo utilizando las herramientas que nos facilitan la librería 'rebound' y 'pygame' de python. (En caso de no tenerla es necesario instalarla previamente a ejecutar dicho notebook).
